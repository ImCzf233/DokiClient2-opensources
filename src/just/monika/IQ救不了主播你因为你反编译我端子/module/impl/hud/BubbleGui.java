      ...
      else if ((this.inModules) && (!this.inModSet) && (this.isActive) && (!this.inSet))
      {
        ...
        else if (ek.getKey() == 28)
        {
          try
          {
            ...
            if ((mod != this) || (mod != DokiDokiLegitClient.getModuleManager().get(TabGUI.class))) {
              mod.toggle();
            }
          }
          catch (Exception e)
        ...
        else if (ek.getKey() == 205)
        {
          ...
          else if ((this.selectedModule != DokiDokiLegitClient.getModuleManager().get(BubbleGui.class)) || (this.selectedModule != DokiDokiLegitClient.getModuleManager().get(TabGUI.class)))
          {
